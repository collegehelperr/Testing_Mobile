 ...
 * Use the {@link SabtuFragment#newInstance} factory method to
...
public class SabtuFragment extends Fragment {
     ...
     * @return A new instance of fragment SabtuFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SabtuFragment newInstance(String param1, String param2) {
        SabtuFragment fragment = new SabtuFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvSabtu = view.findViewById(R.id.rvSabtu);
        btnNew = (Button) view.findViewById(R.id.btn_new_sabtu);
    ...
    private void getMatkul() {
        ...
        getSchedule.enqueue(new Callback<List<schedule>>() {
            ...
            public void onResponse(Call<List<schedule>> call, Response<List<schedule>> response) {
                ...
                rvSabtu.setLayoutManager(new LinearLayoutManager(getContext()));
