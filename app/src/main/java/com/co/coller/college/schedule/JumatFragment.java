 ...
 * Use the {@link JumatFragment#newInstance} factory method to
...
public class JumatFragment extends Fragment {
     ...
     * @return A new instance of fragment JumatFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static JumatFragment newInstance(String param1, String param2) {
        JumatFragment fragment = new JumatFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvJumat = view.findViewById(R.id.rvJumat);
        btnNew = (Button) view.findViewById(R.id.btn_new_jumat);
    ...
    private void getMatkul() {
        ...
        getSchedule.enqueue(new Callback<List<schedule>>() {
            ...
            public void onResponse(Call<List<schedule>> call, Response<List<schedule>> response) {
                ...
                rvJumat.setLayoutManager(new LinearLayoutManager(getContext()));
