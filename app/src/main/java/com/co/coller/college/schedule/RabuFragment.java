...
public class RabuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvRabu = view.findViewById(R.id.rvRabu);
        btnNew = (Button) view.findViewById(R.id.btn_new_rabu);
    ...
    private void getMatkul() {
        ...
        getSchedule.enqueue(new Callback<List<schedule>>() {
            ...
            public void onResponse(Call<List<schedule>> call, Response<List<schedule>> response) {
                ...
                rvRabu.setLayoutManager(new LinearLayoutManager(getContext()));
