...
public class SelasaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvSelasa = view.findViewById(R.id.rvSelasa);
        btnNew = (Button) view.findViewById(R.id.btn_new_selasa);
    ...
    private void getMatkul() {
        ...
        getSchedule.enqueue(new Callback<List<schedule>>() {
            ...
            public void onResponse(Call<List<schedule>> call, Response<List<schedule>> response) {
                ...
                rvSelasa.setLayoutManager(new LinearLayoutManager(getContext()));
