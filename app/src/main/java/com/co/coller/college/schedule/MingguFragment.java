 ...
 * Use the {@link MingguFragment#newInstance} factory method to
...
public class MingguFragment extends Fragment {
     ...
     * @return A new instance of fragment MingguFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static MingguFragment newInstance(String param1, String param2) {
        MingguFragment fragment = new MingguFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvMinggu = view.findViewById(R.id.rvMinggu);
        btnNew = (Button) view.findViewById(R.id.btn_new_minggu);
    ...
    private void getMatkul() {
        ...
        getSchedule.enqueue(new Callback<List<schedule>>() {
            ...
            public void onResponse(Call<List<schedule>> call, Response<List<schedule>> response) {
                ...
                rvMinggu.setLayoutManager(new LinearLayoutManager(getContext()));
